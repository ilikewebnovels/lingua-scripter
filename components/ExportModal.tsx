...
const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose, project, chapters, settings }) => {
  ...
  return (
    ...
    >
      <div className="bg-[var(--bg-secondary)] rounded-md shadow-xl p-4 sm:p-6 w-[95vw] sm:w-full max-w-lg border border-[var(--border-primary)]" onClick={(e) => e.stopPropagation()}>
