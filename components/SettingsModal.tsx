  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 modal-overlay" onClick={onClose}>
        <div className="bg-[var(--bg-secondary)] rounded-xl shadow-2xl w-[95vw] sm:w-full max-w-xl border border-[var(--border-primary)] animate-fade-in max-h-[95vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
