...
const ProjectSidebar: React.FC<ProjectSidebarProps> = ({
  ...
  return (
    <aside className={`sidebar-mobile ${isOpen ? 'open' : ''} bg-[var(--bg-secondary)] border-r border-[var(--border-primary)] flex flex-col h-screen transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'w-[85vw] sm:w-80 md:w-80 lg:w-96' : 'w-0 md:w-0'}`}>
        ...
        <div className="p-4 border-b border-[var(--border-primary)] overflow-hidden">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-md text-[var(--text-secondary)] hover:bg-[var(--bg-tertiary)] transition-colors -mr-2 -mt-1"
                ...
                return activeProject ? (
                  <>
                    ...
                    <div className="flex-1 min-w-0 overflow-hidden">
                      <h2 className="text-lg font-bold text-[var(--accent-primary)] truncate break-all">{activeProject.name}</h2>
