...
import { API_URL, authFetch, getAuthToken } from './apiClient';
...
export const getPromptPreview = async (
    ...
    try {
        const response = await authFetch(`${API_URL}/prompt-preview`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
export const findOriginalPhrases = async (
    ...
    try {
        const response = await authFetch(`${API_URL}/find-phrases`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
export const analyzeForCharacters = async (
    ...
    try {
        const response = await authFetch(`${API_URL}/analyze-characters`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
export const translateBatch = async (
    ...
    try {
        const response = await authFetch(`${API_URL}/translate-batch`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
export const getOpenAIModels = async (
    ...
    try {
        const response = await authFetch(`${API_URL}/openai-models`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
